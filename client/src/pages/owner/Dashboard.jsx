...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Replace below with real API or dynamic data if needed
    if (isOwner) {
      fetchDashboardData()
    }
  }, [isOwner]);
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      including total cars, bookings, pending, confirmed, and recent bookings." />

      <div className='grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 my-8 max-w-3xl'>
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
            ...
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                <div className='hidden md:flex items-center
                 justify-center w-12 h-12 rounded-full bg-white border border-gray-200'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md w-full md:max-w-xs'>
          ...
          <div className='mt-4'>
            <p className='text-3xl mt-6 font-bold text-green-600'>{currency}{data.monthlyRevenue}</p>
          </div>
        </div>
